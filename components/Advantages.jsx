...
export default function Advantages() {
  return (
    <div className='flex flex-col items-center justify-center my-10 bg-[#fdfdfd] py-10'>
      <div>
      ...
      <div className='w-full relative'>
        ...
        />
        {/* LEFT */}
        <div className='absolute sm:top-36 sm:left-52 3xl:top-40 3xl:left-96 w-[600px]'>
        ...
        {/* RIGHT */}
        <div className='absolute sm:top-36 sm:right-52 3xl:top-40 3xl:right-96 w-[600px]'>
        ...
        <div className='absolute sm:top-80 sm:right-16 3xl:top-96 3xl:right-60 w-[600px]'>
          <div className='flex flex-col items-start'>
            <Image
              src='/4.png'
              alt='shape'
